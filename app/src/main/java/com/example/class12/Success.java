...
public class Success extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_success);
         ...
         profileReference = FirebaseStorage.getInstance().getReference();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == GALLERY && resultCode == RESULT_OK){
            ...
            final StorageReference filepath = profileReference.child("profile_image").child(cUser+ ".jpg");
                        ...
                        filepath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                databaseReference.child(cUser).child("profile Image").setValue(url).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()){
                                            Toast.makeText(Success.this, "Upload Success", Toast.LENGTH_SHORT).show();
